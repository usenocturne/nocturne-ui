...
| Hardware-button preset long-press map | `src/hooks/useButtonMapping.jsx` + `App.jsx:useGlobalButtonMapping`; storage is device-scoped through `src/utils/presetStorage.js` using `lastConnectedBluetoothDevice`                                                                                                                   |
