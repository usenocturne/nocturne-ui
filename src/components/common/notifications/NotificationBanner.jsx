  ...
  return (
    <div className="flex items-center gap-3 space-x-3 bg-neutral-900 text-white rounded-xl px-6 py-4 shadow-lg w-full">
      ...
      <div className="flex-1 min-w-0">
        ...
        {description && (
          <div className="text-[18px] opacity-80 truncate">{description}</div>
        )}
      </div>
      {action && (
        <button
      ...
      <button
        onClick={onDismiss}
        className="ml-3 leading-none flex-shrink-0 bg-transparent border-none p-0 flex items-center justify-center"
      >
