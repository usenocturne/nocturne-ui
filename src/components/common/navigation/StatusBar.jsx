...
import { BatteryIcon, BluetoothIcon } from "../icons";

const StatusBar = ({ timezone }) => {
  const [currentTime, setCurrentTime] = useState("");
  const [isFourDigits, setIsFourDigits] = useState(false);
  const [isBluetoothTethered, setIsBluetoothTethered] = useState(true);
  ...
  // Implement a function to check if the device is tethered via Bluetooth
