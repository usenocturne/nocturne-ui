...
const limitColorBrightness = (hexColor) => {
...
const needsDarkGradientEnhancement = (colors) => {
...
const createEnhancedDarkGradient = (colors, accentColor = null) => {
...
const initialMeshGradient = generateMeshGradient(DEFAULT_HEX_COLORS);
