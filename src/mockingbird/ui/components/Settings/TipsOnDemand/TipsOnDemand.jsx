...
const TIPS = [
  {
    title: 'Swipe to skip',
    description: 'Swipe left or right on the Now Playing screen to skip to the next or previous track.',
  },
  {
    title: 'Save a preset',
    description: 'Long press a preset button to save what\'s currently playing for quick access later.',
  },
  {
    title: 'Check your queue',
    description: 'Tap the playlist or album name at the top of the Now Playing screen to see what\'s coming up next.',
  },
  {
    title: 'Adjust the volume',
    description: 'Turn the dial left or right on the Now Playing screen to adjust volume.',
  },
  {
    title: 'Browse your library',
    description: 'Press the back button to return to the shelf where you can browse playlists, artists, and albums.',
  },
  {
    title: 'Scrub through a track',
    description: 'Tap the progress bar on the Now Playing screen, then turn the dial to scrub forward or back.',
  },
  {
    title: 'Shuffle and repeat',
    description: 'Use the shuffle and repeat buttons on the Now Playing screen to change playback mode.',
  },
  {
    title: 'See more items',
    description: 'When browsing the shelf, scroll past the visible items and tap More to see additional content.',
  },
  {
    title: 'Quick restart',
    description: 'Go to Settings, then Power and Reset to restart your Car Thing or perform a factory reset.',
  },
];
