  ...
  var iconList = [
    {
      size: 16,
      svgContent:
        "<path d='M9.125 1.098A.75.75 0 008 1.748V15.25a.75.75 0 00.75.75h5.5a.75.75 0 00.75-.75V4.923a.75.75 0 00-.375-.65l-5.5-3.175zM1 1.75a.75.75 0 011.5 0v13.5a.75.75 0 01-1.5 0V1.75zm5 0a.75.75 0 00-1.5 0v13.5a.75.75 0 001.5 0V1.75z'/>",
    },
    {
      size: 24,
      svgContent:
        "<path d='M3 22a1 1 0 01-1-1V3a1 1 0 012 0v18a1 1 0 01-1 1zM15.5 2.134A1 1 0 0014 3v18a1 1 0 001 1h6a1 1 0 001-1V6.464a1 1 0 00-.5-.866l-6-3.464zM9 2a1 1 0 00-1 1v18a1 1 0 102 0V3a1 1 0 00-1-1z'/>",
    },
  ];
...
export function Experimental__IconCollectionActive(props) {
  return React.createElement(IconCollectionActive, props);
}
