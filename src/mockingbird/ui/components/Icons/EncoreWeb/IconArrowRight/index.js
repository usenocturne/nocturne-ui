  ...
  var iconList = [
    {
      size: 16,
      svgContent:
        "<path d='M.116 8c0 .414.335.75.75.75h12.189l-3.67 3.67a.75.75 0 001.061 1.06L15.926 8l-5.48-5.48a.75.75 0 10-1.06 1.06l3.669 3.67H.865a.75.75 0 00-.75.75z'/>",
    },
    {
      size: 24,
      svgContent:
        "<path d='M1.808 12a1 1 0 001 1h15.97l-4.793 4.793a1 1 0 001.414 1.414L22.607 12l-7.208-7.207a1 1 0 10-1.414 1.414L18.778 11H2.808a1 1 0 00-1 1z'/>",
    },
  ];
...
export function Experimental__IconArrowRight(props) {
  return React.createElement(IconArrowRight, props);
}
