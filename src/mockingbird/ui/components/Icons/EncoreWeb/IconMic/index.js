...
export function IconMic(props) {
  ...
  var iconList = [
    ...
    },
    {
      size: 24,
      svgContent:
        "<path d='M7 5a5 5 0 0110 0v6a5 5 0 01-10 0V5zm5-3a3 3 0 00-3 3v6a3 3 0 106 0V5a3 3 0 00-3-3z'/><path d='M3 7a1 1 0 011 1v3a8 8 0 1016 0V8a1 1 0 112 0v3c0 5.185-3.947 9.449-9 9.95V24h-2v-3.05c-5.053-.5-9-4.764-9-9.95V8a1 1 0 011-1z'/>",
    },
  ];
...
export function Experimental__IconMic(props) {
  return React.createElement(IconMic, props);
}
