  ...
  var iconList = [
    {
      size: 16,
      svgContent:
        "<path d='M4.5 1H15v11.75A2.75 2.75 0 1112.25 10h1.25V2.5H6v10.25A2.75 2.75 0 113.25 10H4.5V1zm0 10.5H3.25a1.25 1.25 0 101.25 1.25V11.5zm9 0h-1.25a1.25 1.25 0 101.25 1.25V11.5z'/>",
    },
    {
      size: 24,
      svgContent:
...
export function Experimental__IconPlaylist(props) {
  return React.createElement(IconPlaylist, props);
}
