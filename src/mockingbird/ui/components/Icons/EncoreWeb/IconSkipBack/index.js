...
export function IconSkipBack(props) {
  ...
  var iconList = [
    ...
    },
    {
      size: 24,
      svgContent:
        "<path d='M6.3 3a.7.7 0 01.7.7v6.805l11.95-6.899a.7.7 0 011.05.606v15.576a.7.7 0 01-1.05.606L7 13.495V20.3a.7.7 0 01-.7.7H4.7a.7.7 0 01-.7-.7V3.7a.7.7 0 01.7-.7h1.6z'/>",
    },
  ];
...
export function Experimental__IconSkipBack(props) {
  return React.createElement(IconSkipBack, props);
}
