  ...
  var iconList = [
    {
      size: 16,
      svgContent:
        "<path d='M1.47 1.47a.75.75 0 011.06 0L8 6.94l5.47-5.47a.75.75 0 111.06 1.06L9.06 8l5.47 5.47a.75.75 0 11-1.06 1.06L8 9.06l-5.47 5.47a.75.75 0 01-1.06-1.06L6.94 8 1.47 2.53a.75.75 0 010-1.06z'/>",
    },
    {
      size: 24,
      svgContent:
...
export function Experimental__IconX(props) {
  return React.createElement(IconX, props);
}
