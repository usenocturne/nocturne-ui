  ...
  var iconList = [
    {
      size: 16,
      svgContent:
        "<path d='M9.375.988a2.75 2.75 0 00-2.75 0l-5.25 3.03A1.75 1.75 0 00.5 5.535v9.724c0 .415.336.75.75.75h4a.75.75 0 00.75-.75V10h4v5.258c0 .415.336.75.75.75h4a.75.75 0 00.75-.75V5.534a1.75 1.75 0 00-.875-1.515L9.375.988z'/>",
    },
    {
      size: 24,
      svgContent:
...
export function Experimental__IconHomeActive(props) {
  return React.createElement(IconHomeActive, props);
}
