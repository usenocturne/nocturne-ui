  ...
  var iconList = [
    {
      size: 16,
      svgContent:
        "<path d='M.999 15h2V5h-2v10zm4 0h2V1h-2v14zM9 15h2v-4H9v4zm4-7v7h2V8h-2z'/>",
    },
    {
      size: 24,
      svgContent:
        "<path d='M8 4v18h2V4H8zM2 22V9h2v13H2zm18-11v11h2V11h-2zm-6 4v7h2v-7h-2z'/>",
    },
  ];
...
export function Experimental__IconNowPlaying(props) {
  return React.createElement(IconNowPlaying, props);
}
