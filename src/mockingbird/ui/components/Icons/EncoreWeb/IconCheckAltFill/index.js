...
export function IconCheckAltFill(props) {
  ...
  var iconList = [
    ...
    },
    {
      size: 24,
      svgContent:
        "<path d='M1 12C1 5.925 5.925 1 12 1s11 4.925 11 11-4.925 11-11 11S1 18.075 1 12zm16.398-2.38a1 1 0 00-1.414-1.413l-6.011 6.01-1.894-1.893a1 1 0 00-1.414 1.414l3.308 3.308 7.425-7.425z'/>",
    },
  ];
...
export function Experimental__IconCheckAltFill(props) {
  return React.createElement(IconCheckAltFill, props);
}
