...
export function IconDeviceMobile(props) {
  ...
  var iconList = [
    ...
    },
    {
      size: 24,
      svgContent:
        "<path d='M5 5a3 3 0 013-3h8a3 3 0 013 3v14a3 3 0 01-3 3H8a3 3 0 01-3-3V5zm3-1a1 1 0 00-1 1v14a1 1 0 001 1h8a1 1 0 001-1V5a1 1 0 00-1-1H8z'/><path d='M13.25 16.75a1.25 1.25 0 11-2.5 0 1.25 1.25 0 012.5 0z'/>",
    },
  ];
...
export function Experimental__IconDeviceMobile(props) {
  return React.createElement(IconDeviceMobile, props);
}
