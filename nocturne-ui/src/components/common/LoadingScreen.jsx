...
const LOADING_QUOTES = [
  "Take a breath, your music awaits",
...
const LoadingScreen = ({ show = true, onComplete }) => {
  ...
  // Fallback: complete loading after 10 seconds max regardless of task status
  useEffect(() => {
    if (!show || onCompleteCalledRef.current) return;
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <div className="relative">
          ...
          <p className="absolute top-full left-1/2 -translate-x-1/2 mt-4 text-[22px] text-white/60 tracking-tight whitespace-nowrap">
            {showReconnectMessage ? "Attempting to reconnect..." : loadingQuote}
          </p>
        </div>
      </div>
    </div>
