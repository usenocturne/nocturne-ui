...
export function useSpotifyPlayerControls(accessToken) {
  ...
  const seekToPosition = useCallback(
    async (positionMs) => {
      if (!accessToken) {
        console.error("seekToPosition: No access token");
        return false;
      }
      ...
      try {
        ...
        console.log(`seekToPosition: Seeking to ${positionMs}ms`);
        ...
        console.log(`seekToPosition: Response status ${response.status}`);
        ...
        console.log("seekToPosition: Success");
        return true;
      } catch (err) {
